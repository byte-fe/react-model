...
},{"./cjs/react.development.js":"../node_modules/react/cjs/react.development.js"}],"helper.ts":[function(require,module,exports) {
"use strict";
...
exports.__esModule = true; /// <reference path="./index.d.ts" />
...
var registerModel = function registerModel(models) {
...
function (_super) {
  ...
  Provider.prototype.render = function () {
    ...
    return React.createElement(helper_1.GlobalContext.Provider, {
      value: __assign({}, GlobalState, {
...
var setPartialState = function setPartialState(name, partialState) {
  var _a;
  ...
  }, _a)); // console.log(GlobalState)

  console.log(Object.keys(Setter.functionSetter['Home']).length, Object.keys(Setter.functionSetter['Shared']).length);
  return GlobalState;
};

var useStore = function useStore(modelName) {
  // const state = useContext(GlobalContext)
  var _a = react_1.useState(GlobalState[modelName].state),
      state = _a[0],
      setState = _a[1];
  ...
  Setter.functionSetter[modelName][_hash] = {
    setState: setState
  };
  ...
  var consumerAction = function consumerAction(action) {
    return function () {
      var params = [];
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4
              /*yield*/
              , action.apply(void 0, [GlobalState[modelName].state, consumerActions(GlobalState[modelName].actions)].concat(params))];
  ...
  var consumerActions = function consumerActions(actions) {
    var ret = {};
  ...
  Object.keys(GlobalState[modelName].actions).map(function (key) {
    return updaters[key] = react_1.useCallback(function (params) {
      return __awaiter(_this, void 0, void 0, function () {
        var newState;
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4
              /*yield*/
              , GlobalState[modelName].actions[key](GlobalState[modelName].state, consumerActions(GlobalState[modelName].actions), params)];
...
var connect = function connect(modelName, mapProps) {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return [4
                        /*yield*/
                        , action.apply(void 0, [GlobalState[modelName].state, consumerActions(actions)].concat(params))];
...
},{"react":"../node_modules/react/index.js","./helper":"helper.ts"}],"../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
